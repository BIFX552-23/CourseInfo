...
schedule <- 
    tibble(Week = 1,
           Date = '', 
           `Coding Demo` =       'Git',
           Lab           = paste('Basic git lesson (TBD)'))

schedule <- bind_rows(schedule,
        tibble(Week = 2,
               Date = '', 
               `Coding Demo` = 'Git (cont)',
               Lab           = '[Class intro](https://bifx552-23.github.io/CourseInfo/),',
...
schedule <- bind_rows(schedule,
        tibble(Week = 5,
               ...
               Lab           = '[RNA-Seq Data](labs/03RNA-seq-data)'))

schedule <- bind_rows(schedule,
        tibble(Week = 6,
               Date = '', 
               `Coding Demo` = 'R Advanced Data',
               Lab           = '[COVID Data](labs/04COVID)'))
