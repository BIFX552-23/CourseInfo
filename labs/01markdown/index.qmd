...
5. Set up a repository using [this GitHub Classroom link](https://classroom.github.com/a/E8-5064m) and push your code and html output to GitHub.

6. Set up GitHub pages on your repository.

7.  Export your document in [Word format](https://quarto.org/docs/output-formats/ms-word.html) and submit it on Blackboard.
