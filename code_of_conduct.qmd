...
This code of conduct is developed for the Fall 2022 section of [BIFX 552](https://github.com/BIFX552-22).
...
This code of conduct, as well as the Hood College Code of Conduct and the Academic Honor Code, applies to all course-related communications, including but not limited to Blackboard, the BIFX cluster, lectures, coding demos, labs, class time, group discussion, MS Teams, other Microsoft products and any other discussions related to BIFX 552. We do not tolerate harassment, intimidation, or bullying of students or staff. Sexual language and imagery are not appropriate in communications or in online venues, including chats.
